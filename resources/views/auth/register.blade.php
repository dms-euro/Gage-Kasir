                    ...
                    <form action="{{ route('registerProses') }}" method="POST">
                        ...
                        <div class="intro-x mt-8">
                            ...
                            <input type="text" name="nama"
                                class="intro-x login__input form-control py-3 px-4 block mt-4" placeholder="Nama">
                            <select class="intro-x login__input form-control py-3 px-4 block mt-4" name="level">
