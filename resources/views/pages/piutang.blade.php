                    ...
                    <tbody>
                        <tr class="intro-x">
                            ...
                            <td class="w-40 !py-4"> <a href=""
                                    class="underline decoration-dotted whitespace-nowrap">#INV-22807556</a> </td>
                            <td class="w-40">
                            ...
                            <td class="text-center">
                                <div class="flex items-center justify-center whitespace-nowrap text-success"> <i
                                        data-lucide="check-square" class="w-4 h-4 mr-2"></i> Completed </div>
                            </td>
                            <td>
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="w-40 !py-4"> <a href=""
                                    class="underline decoration-dotted whitespace-nowrap">#INV-29807556</a> </td>
                            <td class="w-40">
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="w-40 !py-4"> <a href=""
                                    class="underline decoration-dotted whitespace-nowrap">#INV-44807556</a> </td>
                            <td class="w-40">
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="w-40 !py-4"> <a href=""
                                    class="underline decoration-dotted whitespace-nowrap">#INV-54807556</a> </td>
                            <td class="w-40">
                                <a href="" class="font-medium whitespace-nowrap">Denzel Washington</a>
                                <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">Ohio, Ohio</div>
                            </td>
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="w-40 !py-4"> <a href=""
                                    class="underline decoration-dotted whitespace-nowrap">#INV-154807556</a> </td>
                            <td class="w-40">
                                <a href="" class="font-medium whitespace-nowrap">Morgan Freeman</a>
                                <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">Ohio, Ohio</div>
                            </td>
                            <td class="text-center">
                                <div class="flex items-center justify-center whitespace-nowrap text-success"> <i
                            ...
                            <td class="w-40 text-right">
                                <div class="pr-16">$154,000,00</div>
                            </td>
                            <td class="table-report__action">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center text-primary whitespace-nowrap mr-5" href="javascript:;">
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="w-40 !py-4"> <a href=""
                                    class="underline decoration-dotted whitespace-nowrap">#INV-59807556</a> </td>
                            <td class="w-40">
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="w-40 !py-4"> <a href=""
                                    class="underline decoration-dotted whitespace-nowrap">#INV-109807556</a> </td>
                            <td class="w-40">
                            ...
                            <td class="w-40 text-right">
                                <div class="pr-16">$109,000,00</div>
                            </td>
                            <td class="table-report__action">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center text-primary whitespace-nowrap mr-5" href="javascript:;">
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="text-center">
                                <div class="flex items-center justify-center whitespace-nowrap text-pending"> <i
                                        data-lucide="check-square" class="w-4 h-4 mr-2"></i> Pending Payment </div>
                            </td>
                            <td>
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="w-40 !py-4"> <a href=""
                                    class="underline decoration-dotted whitespace-nowrap">#INV-49807556</a> </td>
                            <td class="w-40">
                                <a href="" class="font-medium whitespace-nowrap">Johnny Depp</a>
                                <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">California, LA</div>
                            </td>
