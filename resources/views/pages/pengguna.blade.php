                    ...
                    <tbody>
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="text-center">
                                @if($user->level == 'admin')
                                    <span class="px-2 py-1 bg-primary/20 text-primary rounded-full text-xs">Admin</span>
                                @else
                                    <span class="px-2 py-1 bg-slate-100 text-slate-600 rounded-full text-xs">Pengguna</span>
                                @endif
                            </td>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('user.store') }}" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" data-tw-dismiss="modal" class="btn btn-outline-secondary w-24">Batal</button>
        ...
        <div class="modal-content">
            ...
            <form id="form-edit-user" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-4">
                        <label class="form-label">Password <span class="text-slate-400">(Kosongkan jika tidak diubah)</span></label>
