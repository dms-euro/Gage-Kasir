                    ...
                    <div class="report-box-2 intro-y mt-5">
                        <div class="box grid grid-cols-12">
                            <div class="col-span-12 lg:col-span-4 px-8 py-12 flex flex-col justify-center">
                                ...
                                <div class="justify-start flex items-center text-slate-600 dark:text-slate-300 mt-12"> My
                                    Total Assets <i data-lucide="alert-circle" class="tooltip w-4 h-4 ml-1.5"
                                ...
                                <ul class=" nav nav-pills w-60 border border-slate-300 dark:border-darkmode-300 border-dashed rounded-md mx-auto p-1 mb-8 "
                                    ...
                                    <li id="weekly-report-tab" class="nav-item flex-1" role="presentation">
                                        <button class="nav-link w-full py-1.5 px-2 active" data-tw-toggle="pill"
                                            ...
                                            aria-controls="weekly-report" aria-selected="true"> Weekly </button>
                                    </li>
                    ...
                    <div class="mt-5">
                            ...
                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                    <img alt="Midone - HTML Admin Template"
                                        src="{{ asset('templates/Compiled/dist/images/profile-13.jpg') }}">
                                </div>
                                <div class="ml-4 mr-auto">
                                    <div class="font-medium">Russell Crowe</div>
                                    <div class="text-slate-500 text-xs mt-0.5">18 June 2022</div>
                                </div>
                                <div
                        ...
                        <div class="intro-y">
                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                    <img alt="Midone - HTML Admin Template"
                                        src="{{ asset('templates/Compiled/dist/images/profile-8.jpg') }}">
                                </div>
                                <div class="ml-4 mr-auto">
                                    <div class="font-medium">Robert De Niro</div>
                                    <div class="text-slate-500 text-xs mt-0.5">16 November 2021</div>
                                </div>
                                <div
                                    class="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">
                                    137 Sales</div>
                        ...
                        <div class="intro-y">
                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                    <img alt="Midone - HTML Admin Template"
                                        src="{{ asset('templates/Compiled/dist/images/profile-15.jpg') }}">
                                </div>
                                <div class="ml-4 mr-auto">
                    ...
                    <div class="intro-y box p-5 mt-12 sm:mt-5">
                        ...
                        <div class="flex items-center mb-5">
                            <div class="flex items-center">
                                <div>Site Visits</div>
                                <div class="text-danger flex text-xs font-medium tooltip cursor-pointer ml-2"
                                    title="49% Higher than last month"> -2% <i data-lucide="chevron-down"
                                        class="w-4 h-4 ml-0.5"></i> </div>
                            </div>
                        ...
                        <div class="flex items-center mb-5">
                            <div class="flex items-center">
                                <div>Page Views</div>
                                <div class="text-success flex text-xs font-medium tooltip cursor-pointer ml-2"
                                    title="49% Higher than last month"> 5% <i data-lucide="chevron-up"
                                        class="w-4 h-4 ml-0.5"></i> </div>
                            </div>
                        ...
                        <div class="flex items-center mb-5">
                            <div class="flex items-center">
                                <div>% New Visits</div>
                                <div class="text-danger flex text-xs font-medium tooltip cursor-pointer ml-2"
                                    title="49% Higher than last month"> -9% <i data-lucide="chevron-down"
                                        class="w-4 h-4 ml-0.5"></i> </div>
                            </div>
                                        ...
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('templates/Compiled/dist/images/preview-10.jpg') }}"
                                                    title="Uploaded at 18 June 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('templates/Compiled/dist/images/preview-2.jpg') }}"
                                                    title="Uploaded at 10 August 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('templates/Compiled/dist/images/preview-13.jpg') }}"
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('templates/Compiled/dist/images/preview-3.jpg') }}"
                                                    title="Uploaded at 16 November 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('templates/Compiled/dist/images/preview-4.jpg') }}"
                                                    title="Uploaded at 22 April 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('templates/Compiled/dist/images/preview-15.jpg') }}"
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('templates/Compiled/dist/images/preview-1.jpg') }}"
                        ...
                        <div
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                <div
                                    ...
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="Midone - HTML Admin Template"
                                            src="{{ asset('templates/Compiled/dist/images/profile-3.jpg') }}">
                                    </div>
                                </div>
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                <div
                                    ...
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="Midone - HTML Admin Template"
                                            src="{{ asset('templates/Compiled/dist/images/profile-11.jpg') }}">
                                    </div>
                                </div>
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    <div class="flex items-center">
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                <div
                                    ...
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="Midone - HTML Admin Template"
                                            src="{{ asset('templates/Compiled/dist/images/profile-6.jpg') }}">
                                    </div>
                                </div>
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    <div class="flex items-center">
                        ...
                        <div class="mt-5">
                            ...
                            <div class="intro-x">
                                <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                    ...
                                    <div class="ml-4 mr-auto">
                                        <div class="font-medium">Robert De Niro</div>
                                        <div class="text-slate-500 text-xs mt-0.5">15 June 2020</div>
                                    </div>
                                    <div class="text-danger">-$23</div>
                                </div>
                            </div>
                            <a href=""
