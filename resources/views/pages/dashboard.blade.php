    ...
    <div class="col-span-12 mt-8">
        ...
        <div class="intro-y box p-5 mt-5 bg-primary/5 border border-primary/20">
            <div class="flex items-center">
                <div>
                    <div class="text-primary font-medium text-lg">{{ \Carbon\Carbon::now()->translatedFormat('l, d F Y') }}</div>
                    <div class="text-slate-500 mt-1">Pantau performa bisnis percetakan Anda hari ini</div>
                </div>
                <div class="ml-auto">
                    <i data-lucide="trending-up" class="w-12 h-12 text-primary/50"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-span-12 sm:col-span-6 xl:col-span-3">
        <div class="intro-y box p-5 zoom-in">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <div class="text-slate-500 text-sm">Order Hari Ini</div>
                    <div class="text-2xl font-bold">{{ $orderHariIni }}</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="intro-y box p-5 zoom-in">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <div class="text-2xl font-bold text-success">Rp {{ number_format($omsetHariIni, 0, ',', '.') }}</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="intro-y box p-5 zoom-in">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <div class="text-2xl font-bold text-warning">Rp {{ number_format($totalPiutang, 0, ',', '.') }}</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-span-12 lg:col-span-4 mt-5">
        <div class="intro-y box p-5">
            ...
            <div class="space-y-3">
                ...
                <a href="{{ route('produksi.invoice', $order->id_produksi) }}" class="flex items-center p-2 hover:bg-slate-50 rounded-md transition">
    ...
    <div class="col-span-12 lg:col-span-6 mt-5">
        <div class="intro-y box p-5">
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <a href="{{ route('pelanggan.index') }}" class="btn btn-outline-secondary py-3 justify-start">
