...
<div>
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a href="{{ route('produksi.invoice', $piutang->id_produksi) }}" class="btn btn-outline-primary shadow-md mr-2" target="_blank">
            ...
            <div class="box p-5 mt-5">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="text-success">Rp {{ number_format($piutang->total_terbayar, 0, ',', '.') }}</span>
                    </div>
                    <div class="border-t pt-2 mt-2">
                        <div class="flex justify-between font-medium">
                            <span>Sisa Tagihan</span>
                            <span class="text-warning text-lg">Rp {{ number_format($piutang->sisa_tagihan, 0, ',', '.') }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box p-5 mt-5">
                ...
                <form action="{{ route('piutang.bayar', $piutang->id_produksi) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <small class="text-slate-500">Maks: Rp {{ number_format($piutang->sisa_tagihan, 0, ',', '.') }}</small>
                    </div>
                    <div class="mb-4">
                ...
                <table class="table table-sm">
                    ...
                    <tfoot>
                        <tr class="font-bold">
                            ...
                            <td class="text-right text-primary">Rp {{ number_format($piutang->total_tagihan, 0, ',', '.') }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
            ...
            <div class="box p-5 mt-5">
                ...
                <table class="table table-sm">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr><td colspan="4" class="text-center text-slate-500">Belum ada pembayaran</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
