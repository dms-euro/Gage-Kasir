    ...
    <div>
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                    <button class="btn btn-primary shadow-md mr-2" data-tw-toggle="modal" data-tw-target="#modal-kategori">
                        <i data-lucide="plus" class="w-4 h-4 mr-1"></i> Tambah Kategori Baru
                    </button>
                </div>
                <div class="hidden md:block mx-auto text-slate-500">
                    Menampilkan {{ $kategoris->count() }} dari {{ $kategoris->total() }} data kategori
                </div>
                                ...
                                <td class="table-report__action w-56">
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center mr-3" href="javascript:;" data-tw-toggle="modal"
                                            ...
                                            onclick="openEdit({{ $kategori->id }}, '{{ $kategori->nama_kategori }}')">
        ...
        {{-- MODAL --}}
        {{-- Tambah --}}
        <div id="modal-kategori" class="modal" tabindex="-1" aria-hidden="true">
        ...
        <div id="modal-edit" class="modal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h2 class="font-medium text-base">Edit Kategori</h2>
                    </div>
            ...
            <script>
                function openEdit(id, nama) {
                    ...
                    document.getElementById('edit-form').action =
                        `/produksi/kategori/${id}`;
                }
            </script>
            <script>
                function setDelete(id) {
                    let form = document.getElementById('delete-form');
                    form.action = `/produksi/kategori/${id}`;
                }
            </script>
            <script>
