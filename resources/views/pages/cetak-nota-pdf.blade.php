...
<body>
    ...
    <div class="nota-container">
        ...
        <table width="100%" style="margin-bottom:15px; font-size:11px;">
            <tr>
                <!-- DARI -->
                <td width="50%" valign="top" style="padding-right:10px;">
                    <table>
                        <tr>
                            ...
                            <td>: {{ $Profilperusahaan->nama ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td><strong>Alamat</strong></td>
                            <td>: {{ $Profilperusahaan->alamat ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td><strong>Telepon</strong></td>
                            <td>: {{ $Profilperusahaan->telepon ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td><strong>Email</strong></td>
                            <td>: {{ $Profilperusahaan->email ?? '-' }}</td>
                        </tr>
                    </table>
                </td>
                ...
                <td width="50%" valign="top" style="padding-left:10px;">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>: {{ $produksi->pelanggan->jenisPelanggan?->nama_jenis ?? '-' }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <div class="footer-note">
            <div class="nota-inline">
                <span>#{{ $produksi->id_produksi }}</span>
                <span style="margin-left:20px;">PIC: {{ $produksi->pic ?? '-' }}</span>
                <span style="margin-left:20px;">Pembayaran: {{ $produksi->pembayaran }}</span>
            </div>
        </div>
